...
export default function MissionState() {
    ...
    const [familyMember, setFamilyMember] = useState(['엄마', '아빠', '은상', '우주', '민재']);
                    ...
                    return(
                        <View key={i} style={styles.familyStateBox}> 
                            ...
                            <View style={styles.profileTextArea}> 
                                <Text style={styles.profileText1}>엄마</Text>
                                <Text style={styles.profileText2}>참여 완료!</Text>
                            </View>
